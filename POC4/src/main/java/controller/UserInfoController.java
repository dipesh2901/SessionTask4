...
public class UserInfoController {
	...
	public static String updateUser(String username, UserInformation user) throws SQLException {
		Connection con = JDBCConnection.openConnection();
		int success=0;
		PreparedStatement pst = null;
	...
	public static String payUser(String username, String payeeUsername, Double amountToPay) {
